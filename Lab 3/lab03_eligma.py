# Program: The Eligma Code
# Informasi: decimal value a-z adalah 97-122, decimal value 0-9 adalah 48-57
...
for char in kalimat_masukan:
    if 96 < ord(char) < 123:  # Mengecek apakah karakter merupakan alfabet
        kalimat_bersih += char  # Tambahkan ke kalimat
    else:  # Karena dijamin tidak ada karakter selain a-z dan 0-9
...
for char in kalimat_bersih:
    ...
    # Mekanisme geser z-a
    while char_temp > 122:  # Apabila di luar range a-z
        char_temp -= 26  # "Lempar" balik ke 'a'
